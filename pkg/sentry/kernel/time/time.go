...
type ResettableTimer struct {
	...
	// fn is ran in a goroutnine when the Timer expires. fn is immutable.
	fn func()
	...
	// called since Timer cannot be restarted once it has fired.
	//
...
// in its own gorountine. The timer is started immediately and will fire
// exactly once. The second return value is the start time used with the
// duration.
//
