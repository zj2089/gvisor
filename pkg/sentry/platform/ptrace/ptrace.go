...
import (
	...
	kcontext "gvisor.dev/gvisor/pkg/context"
...
func (c *context) Switch(ctx kcontext.Context, mm platform.MemoryManager, ac arch.Context, cpu int32) (*arch.SignalInfo, usermem.AccessType, error) {
	as := mm.AddressSpace()
	s := as.(*subprocess)
