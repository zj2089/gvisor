...
type Clock interface {
	...
	// NewTimer returns a new Timer that can be used to schedule f to run in its
	// own gorountine. l will be locked before calling f then unlocked after f
	// returns.
	//
