...
func (s *Subnet) IsBroadcast(address Address) bool {
	...
	// address but there is an exception where a simple comparision is not
	// correct. This exception is for /31 and /32 IPv4 subnets where each
	// address is considered a valid host address.
	//
