...
func TestOutgoingBroadcastWithEmptyRouteTable(t *testing.T) {
	...
	if err := verifyRoute(r, stack.Route{LocalAddress: header.IPv4Any, RemoteAddress: header.IPv4Broadcast, RemoteLinkAddress: header.EthernetBroadcastAddress}); err != nil {
...
func TestOutgoingBroadcastWithRouteTable(t *testing.T) {
	...
	if err := verifyRoute(r, stack.Route{LocalAddress: nic1Addr.Address, RemoteAddress: header.IPv4Broadcast, RemoteLinkAddress: header.EthernetBroadcastAddress}); err != nil {
